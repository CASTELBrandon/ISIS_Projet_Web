...
******************************************/
  ...
  */
  ...
  /*********Fonctions de la gestion des couleurs*********/
  ...
  function buttonConnectTrigger() {
    if (flag == true) {
      ...
      if (address == null || address == "") {
        ...
        var clientWeb = new MQTTClient(address, 9001, "ClientWeb"); //Objet client
        clientWeb.MQTTConnect(username, password);
      }
...
******************************************/  
  ...
  //>>Évènement sur support cliquable
    ...
    */
    ...
    //>>Evènements du bouton de connexion
